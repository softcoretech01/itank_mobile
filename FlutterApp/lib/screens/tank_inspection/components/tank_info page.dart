...
class TankInfoPageState extends State<TankInfoPage> {
  ...
  TextEditingController(text: _formatToday());
  ...
  final TextEditingController lifterWeightValueController = TextEditingController();
  ...
  void previewImage({File? file, String? networkUrl, required String title}) {
    showImagePreviewBottomSheet(context, file: file, networkUrl: networkUrl, title: title);
  }
  ...
  TankInfoData getFormData() {
    return TankInfoData(
      ...
      inspectionId: currentInspection?.data?.inspectionId ?? context.read<TankInspectionBloc>().state.inspectionId,
          ...
          if (state.status == FlowStatus.ready) {
            ...
            if (selectedTankId != null) {
              selectedTank = allTanks.firstWhere(
                ...
                orElse: () => ActiveTank(
                  tankId: masterDetails?.data?.tankId ??
                      inspectionDetails?.data?.tankId,
                  tankNumber: masterDetails?.data?.tankNumber ??
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            child: InputDecorator(
                              decoration: InputDecoration(
                                labelText: selectedTank == null ? "" : "Select Tank",
                        ...
                        imageFieldBox(
                          label: lifterWeightController.text.isEmpty ? "Lifter Weight Image" : lifterWeightController.text,
  ...
  Widget dropDownForTankStatus(
    ...
    return Container(
      ...
      child: DropdownButtonFormField<TankStatus>(
        initialValue: value,
        items: items
            ?.map((e) => DropdownMenuItem<TankStatus>(
          value: e,
                        ...
                        return ListTile(
                          ...
                          onTap: () async {
                            ...
                            setState(() {
                              ...
                              // 🔥 CLEAR ALL INSPECTION-SPECIFIC FIELDS
                              statusMaster = null;
                              inspectionMaster = null;
                              safetyValveMaster = null;
                              productMaster = null;
                            ...
                            // 🔁 Trigger full inspection/tank flow (includes tank-details API)
                            context
                                .read<TankInspectionBloc>()
                                .add(SelectTankEvent(tank.tankId));
                          },
                        );
                      },
                    ),
  ...
  void fillInspectionForm(TankData data) {
    ...
    // Date
    dateController.text = data.inspectionDate?.split("T").first ?? _formatToday();
